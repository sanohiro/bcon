...
| ペイン閉じる | `Ctrl+Shift+W` | 同左 | 同左 | アクティブペインを閉じる |
| ペイン移動 | `Ctrl+Shift+矢印` | `Ctrl+Shift+H/J/K/L` | `Ctrl+Shift+矢印` | ペイン間のフォーカス移動 |
| ペインリサイズ | `Ctrl+Shift+Alt+矢印` | `Ctrl+Shift+Alt+H/J/K/L` | `Ctrl+Shift+Alt+矢印` | アクティブペインのリサイズ |
